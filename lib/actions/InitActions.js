...
var initHome = function initHome(profile) {
  return function (dispatch, getState) {
    ...
    return [HistoryActions.initPriceBrackets(), HistoryActions.initWaterBreakdown(), CommonsActions.getMyCommons(), DashboardActions.fetchAllWidgetsData()].reduce(function (prev, curr) {
