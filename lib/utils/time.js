...
var getTimeByPeriod = function getTimeByPeriod(period, index) {
  if (period === 'year') return getYear(moment().subtract(index, period).valueOf());else if (period === 'month') return getMonth(moment().subtract(index, period).valueOf());else if (period === 'week') return getWeek(moment().subtract(index, period).valueOf());else if (period === 'day') return getDay(moment().subtract(index, period).valueOf());
  return {};
...
var getComparisonPeriod = function getComparisonPeriod(timestamp, period, _t) {
