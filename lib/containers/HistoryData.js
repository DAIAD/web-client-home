...
function mergeProps(stateProps, dispatchProps, ownProps) {
  ...
  var availableComparisons = getComparisons(devType, stateProps.memberFilter, members).map(function (c) {
    return {
      id: c,
      title: getComparisonTitle(stateProps.activeDeviceType, c, stateProps.time.startDate, stateProps.timeFilter, favoriteCommonName, members, _t)
    };
  });
  ...
  var _map = ['periods', 'comparisons', 'sort'].map(function (x) {
    return activeMode[x] ? allOptions[x].filter(function (y) {
