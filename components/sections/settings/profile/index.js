...
const { uploadFile, validatePassword, filterObj } = require('../../../../utils/general');
...
const ProfileForm = React.createClass({
  componentWillMount: function () {
    const profileForm = filterObj(this.props.profile, [
      'firstname', 
      'lastname', 
      'photo',
      'email', 
  ...
  render: function () {
    const { _t, profileForm: profile, locale, errors, actions } = this.props;
